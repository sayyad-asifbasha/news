...
let url="https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=03ded8b29e214785ac1c6e4b0876b395";

// let url = "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=3250e7d8113e475bbf5f9e6f432dda5c&page=1";

export default function Sports_News() {
  ...
  const allocateData = async () => {
    if (!localStorage.getItem('Sports')) {
      ...
      localStorage.setItem('Sports', JSON.stringify(result));
      setData(JSON.parse(localStorage.getItem('Sports')));
      console.log("hiited")
    }
    else {
      setData(JSON.parse(localStorage.getItem('Sports')));
